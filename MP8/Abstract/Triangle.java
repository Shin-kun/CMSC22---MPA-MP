...
public class Triangle extends Shape{
	...
	public double getArea() {
		double angleInDegrees = Math.toDegrees(angle3);		
		return 0.5 * side1 * (Math.sin(angleInDegrees) * side2); //it always helps if you draw a triangle 
	}
	...
	public String toString() {
		String shape;
		shape = String.format("A Circle with side lengths: %.2f, %.2f, %.2f and angle measures: %.2f, %.2f, %.2f which is a subclass of %s",side1, side2, side3, angle1, angle2, angle3, super.toString());
		return shape;
	}
}
